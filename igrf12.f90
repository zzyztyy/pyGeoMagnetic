...
subroutine igrf12syn (isv, date, itype, alt, colat, elong, x, y, z, f)
    ...
    dimension gh(3451), g0(120), g1(120), g2(120), g3(120), g4(120), &
            g5(120), g6(120), g7(120), g8(120), g9(120), ga(120), &
            gb(120), gc(120), gd(120), ge(120), gf(120), gg(120), &
            gi(120), gj(120), gk(195), gl(195), gm(195), gp(195), &
            gq(195), gr(195), &
            p(105), q(105), cl(13), sl(13)
    equivalence (g0, gh(1)), (g1, gh(121)), (g2, gh(241)), (g3, gh(361)), &
            (g4, gh(481)), (g5, gh(601)), (g6, gh(721)), (g7, gh(841)), &
            (g8, gh(961)), (g9, gh(1081)), (ga, gh(1201)), &
            (gb, gh(1321)), (gc, gh(1441)), (gd, gh(1561)), &
            (ge, gh(1681)), (gf, gh(1801)), (gg, gh(1921)), &
            (gi, gh(2041)), (gj, gh(2161)), (gk, gh(2281)), &
            (gl, gh(2476)), (gm, gh(2671)), (gp, gh(2866)), &
    ...
    961 format (/' This subroutine will not work with a date of', &
            f9.3, '.  Date must be in the range 1900.0.ge.date', &
